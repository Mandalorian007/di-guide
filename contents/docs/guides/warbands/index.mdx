...
To create or join a warband:
1. Open the menu and select the "Warband" tab
2. You can either create a new warband or accept an invitation to join one
3. Ideally, coordinate with other active players from your clan

## Warband Remnants

Warband Remnants provide passive bonuses to all warband members when installed in your Warband Castle rooms.

<Image src="/warband-rems.png" alt="Warband Remnants Overview" width={800} height={600} />
...
- **Best Perk**: Straight damage increase remnants
...
- **Best Perk**: Block chance remnants
